...
"""
and, or, not Boolean Logic Cheat Sheet

a or b -->	if a is false, a is returned. Otherwise b is returned
a and b -->	if a is false, b is returned. If a is true, a is returned
